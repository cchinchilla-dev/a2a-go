...
const (
	// APIKeySecuritySchemeInCookie indicates the API key is passed via a cookie.
	APIKeySecuritySchemeInCookie APIKeySecuritySchemeIn = "cookie"
	// APIKeySecuritySchemeInHeader indicates the API key is passed via a header.
	APIKeySecuritySchemeInHeader APIKeySecuritySchemeIn = "header"
	// APIKeySecuritySchemeInQuery indicates the API key is passed via a query parameter.
